...
If you want to re-evaluate these methods by using SOCToolbox, please add `Attributes` files to and `MINet/SOC/` slightly modify the path in `attr_categoty_and_generate_list.py` to automatively split 8 attributes.
