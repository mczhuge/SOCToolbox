...
额外的新模型SOC预测图：[SCWSSOD](https://arxiv.org/abs/2012.04404)在[百度网盘|提取码: z3fq](https://pan.baidu.com/s/1eGGokt33eaZGsJ5n5VRt4Q).
...
另外，也可以测试SOC-Test，我们命名为原始的SOC-Test Set为 SOC-1200， 以下为另一个模型SCWSSOD的SOC-1200结果。
```
